              ...
              <div className="grid gap-3 sm:gap-4">
                {data.contacts.map((contact, index) => (
                  <Card key={index} className="p-4 sm:p-5 md:p-6">
                    ...
                    >
                      <div className="flex h-12 w-12 items-center justify-center rounded-full bg-crimson/10 text-crimson transition-colors group-hover:bg-crimson group-hover:text-white">
                        {contact.label === 'Call' && (
                      ...
                      <div>
                        <p className="text-sm font-semibold text-charcoal/60">{contact.label}</p>
                        <p className="text-base font-medium text-charcoal group-hover:text-crimson transition-colors">{contact.value}</p>
                      </div>
                    </a>
                  </Card>
                ))}
                ...
                <ul className="space-y-2">
                  {data.studio.hours.map((hour, index) => (
                    <li key={index} className="flex items-center gap-3 text-base text-charcoal/70">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="h-5 w-5 text-crimson">
